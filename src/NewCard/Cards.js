...
const NewCard = () => {
  ...
  const capturarIdTarjeta = async () => {
    ...
    try {
      ...
      const response = await axios.get('http://107.20.128.254:5000/api/ultimoId'); //ip publica de instancia servidor
  ...
  const handleFormSubmit = (event) => {
    ...
    axios.post('http://107.20.128.254:5000/api/agregar_tarjeta', nuevaTarjeta) //ip publica de instancia servidor
      .then(response => {
