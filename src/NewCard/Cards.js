...
const NewCard = () => {
  ...
  const capturarIdTarjeta = async () => {
    ...
    try {
      ...
      const response = await axios.get('http://34.227.111.125:5000/api/ultimoId'); //ip publica de instancia servidor
  ...
  const handleFormSubmit = (event) => {
    ...
    axios.post('http://34.227.111.125:5000/api/agregar_tarjeta', nuevaTarjeta) //ip publica de instancia servidor
      .then(response => {
